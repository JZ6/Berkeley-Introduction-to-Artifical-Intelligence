...
def sudokuCSP(initial_sudoku_board, model='neq'):
	...
	i1 += 1
        if model == 'neq':
            ...
            #use AllDiff Constraint
	    constraint_list.append(create_all_diff_constraint("row" + str(i1), row))
    i1 = 0
	...
	i1 += 1
        ...
        if model == 'neq':
            ...
            constraint_list.append(create_all_diff_constraint("column" + str(i1), scope))
    ...
    for i in [0, 3, 6]:
        for j in [0, 3, 6]:
            ...
            if model == 'neq':
                ...
                constraint_list.append(create_all_diff_constraint("square" + str(i) + str(j), scope))
...
def create_all_diff_constraint(name, var_list):
	'''create a allDiffConstraint'''
	con = AllDiffConstraint(name, var_list);
	return con
